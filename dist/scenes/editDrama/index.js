...
var editDeleteWizard = new Scenes.WizardScene("editDrama", Composer.on("message", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                ctx.session.page = 0;
                request = ctx.message.text.replace("/editD", "").trim();
                searchCriteria = {
                    dramaName: request,
                    quality: undefined,
                    year: undefined,
            ...
            case 1:
                ...
                return [4 /*yield*/, ctx.replyWithPhoto(photo, {
                        ...
                        reply_markup: keyboard.makeAdminButtons("https://t.me/".concat(env.botUserName, "?start=").concat(finalResult[0].shareId, "-d"), ctx.session.next || "", ctx.session.prev || ""),
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if (!dramaData) return [3 /*break*/, 17];
            ...
            case 1:
                ...
                return [4 /*yield*/, ctx.editMessageCaption("```Json\n".concat(makeDramaCaption(dramaData[page + 1]), "\n```"), {
                        reply_markup: keyboard.makeAdminButtons("https://t.me/".concat(env.botUserName, "?start=").concat(dramaData[page + 1].shareId, "-d"), ctx.session.next || "", ctx.session.prev || ""),
                        parse_mode: "MarkdownV2",
                    })];
            case 2:
                _d.sent();
                ctx.session.selectedShareId =
                    dramaData[page + 1].shareId;
                return [3 /*break*/, 5];
            ...
            case 14:
                ...
                return [4 /*yield*/, ctx.reply("What you want to edit in this drama", {
                        reply_markup: keyboard.editDramaButtons(),
                    })];
            case 15:
                _d.sent();
                return [2 /*return*/, ctx.wizard.next()];
            ...
            case 20: return [4 /*yield*/, sendCallbackQueryResponse(ctx, "you need to search again this drama !!!")];
            case 21:
                _d.sent();
                _d.label = 22;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, ctx.reply("enter the name drama ")];
            case 1:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 2:
                ...
                return [4 /*yield*/, ctx.reply("enter year of this drama")];
            case 3:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 4:
                ...
                return [4 /*yield*/, ctx.reply("enter season of this drama", keyboard.oneTimeSeasonKeyboard())];
            case 5:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 6:
                ...
                return [4 /*yield*/, ctx.reply("enter quality of this drama", keyboard.oneTimeQualityKeyboard())];
            case 7:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 8:
                ...
                return [4 /*yield*/, ctx.reply("enter total episode of this drama")];
            case 9:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 10:
                ...
                return [4 /*yield*/, ctx.reply("enter the language of this drama", keyboard.oneTimeLangKeyboard())];
            case 11:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 12:
                ...
                return [4 /*yield*/, ctx.reply("enter the subtitle of this drama", keyboard.oneTimeSubKeyboard())];
            case 13:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 14:
                ...
                return [4 /*yield*/, ctx.reply("enter the rating of this drama", keyboard.oneTimeRatingKeyboard())];
            case 15:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 16:
                ...
                return [4 /*yield*/, ctx.reply("Send a poster of this drama")];
            case 17:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 18:
                ...
                return [4 /*yield*/, ctx.reply("Send the synopsis of this drama")];
            case 19:
                _a.sent();
                return [2 /*return*/, ctx.wizard.next()];
            case 20:
            ...
            case 26:
                _a.sent();
                return [4 /*yield*/, database.deleteDrama(selectedShareId)];
            case 27:
                _a.sent();
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                if (!(tracker.startsWith("name") &&
                    ctx.message &&
                    "text" in ctx.message &&
                    ctx.message.text !== "/cancel")) return [3 /*break*/, 4];
                return [4 /*yield*/, database.updateDramaAttribute(selectedShareId, {
                        dramaName: ctx.message.text,
                    })];
            case 1:
                _e.sent();
            ...
            case 13: return [4 /*yield*/, ctx.reply("Add Drama Canceled start again /editD")];
            case 14:
                _e.sent();
                return [4 /*yield*/, ctx.scene.leave()];
            ...
            case 69:
                ...
                return [4 /*yield*/, ctx.reply("Share Drama Canceled start again /editD")];
            case 70:
                _e.sent();
                return [4 /*yield*/, ctx.scene.leave()];
            ...
            case 73:
                ...
                return [4 /*yield*/, telegram.forwardMessages(env.dbDramaChannelId, (_b = ctx.chat) === null || _b === void 0 ? void 0 : _b.id, messageIds ? messageIds : [])];
            case 74:
                forwardedMessageIds = _e.sent();
                return [4 /*yield*/, database.addDramaEps(selectedShareId, forwardedMessageIds)];
            case 75:
                _e.sent();
