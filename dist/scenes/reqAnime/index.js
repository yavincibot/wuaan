...
var paginationWizard = new Scenes.WizardScene("reqAnime", Composer.on("message", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                ctx.session.page = 0;
                request = ctx.message.text.replace("/a", "").trim();
                searchCriteria = {
                    animeName: request,
                    quality: undefined,
                    language: undefined,
            ...
            case 1:
                ...
                return [4 /*yield*/, ctx.replyWithPhoto(photo, {
                        ...
                        reply_markup: makeButtons("https://t.me/".concat(env.botUserName, "?start=").concat(finalResult[0].shareId, "-a"), ctx.session.next || "", ctx.session.prev || ""),
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if (!animeData) return [3 /*break*/, 12];
            ...
            case 1:
                ...
                return [4 /*yield*/, ctx.editMessageCaption("```\n".concat(makeAnimeCaption(animeData[page + 1]), "\n```"), {
                        reply_markup: makeButtons("https://t.me/".concat(env.botUserName, "?start=").concat(animeData[page + 1].shareId, "-a"), ctx.session.next || "", ctx.session.prev || ""),
                        parse_mode: "MarkdownV2",
                    })];
            case 2:
                _d.sent();
            ...
            case 15: return [4 /*yield*/, sendCallbackQueryResponse(ctx, "you need to search again this anime !!!")];
            case 16:
                _d.sent();
                _d.label = 17;
