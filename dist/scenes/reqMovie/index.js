...
var paginationWizard = new Scenes.WizardScene("reqMovie", Composer.on("message", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, ctx.replyWithPhoto(photo, {
                        ...
                        reply_markup: makeButtons("https://t.me/".concat(env.botUserName, "?start=").concat(finalResult[0].shareId, "-m"), ctx.session.next || "", ctx.session.prev || ""),
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if (!movieData) return [3 /*break*/, 12];
            ...
            case 1:
                ...
                return [4 /*yield*/, ctx.editMessageCaption("```\n".concat(makeMovieCaption(movieData[page + 1]), "\n```"), {
                        reply_markup: makeButtons("https://t.me/".concat(env.botUserName, "?start=").concat(movieData[page + 1].shareId, "-m"), ctx.session.next || "", ctx.session.prev || ""),
                        parse_mode: "MarkdownV2",
                    })];
            case 2:
                _d.sent();
            ...
            case 7:
                _d.sent();
                return [4 /*yield*/, ctx.editMessageCaption("```\n ".concat(makeMovieCaption(movieData[page - 1]), "\n```"), {
                        reply_markup: makeButtons("https://t.me/".concat(env.botUserName, "?start=").concat(movieData[page].shareId, "-m"), ctx.session.next || "", ctx.session.prev || ""),
                        parse_mode: "MarkdownV2",
                    })];
            case 8:
                _d.sent();
            ...
            case 15: return [4 /*yield*/, sendCallbackQueryResponse(ctx, "you need to search again this movie !!!")];
            case 16:
                _d.sent();
                _d.label = 17;
